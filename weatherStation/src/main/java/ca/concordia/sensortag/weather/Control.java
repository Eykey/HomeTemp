...
public class Control extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        address = newint.getStringExtra(PairHC.EXTRA_ADDRESS); //receive the address of the bluetooth device

        //view of the ledControl
        setContentView(R.layout.activity_control);

        OnOff = (Button)findViewById(R.id.onoff_button);
        ...
        OnOff.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                turnOnOffLed();      //method to turn on
            }
        });
    ...
    private void gotoWeatherStationActivity() {
        Intent i = new Intent(getApplicationContext(), WeatherStationActivity.class);
        startActivity(i);
    }
